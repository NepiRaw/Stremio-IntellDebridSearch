...
export async function coordinateSearch(params) {
    ...
    if (titleMatches.length > 0) {
        ...
        await batchFetchTorrentDetails(titleMatches, providers[provider], apiKey);

        // Perform content analysis for episode matching
        matches = performContentAnalysis(titleMatches, season, episode, absoluteEpisode);
